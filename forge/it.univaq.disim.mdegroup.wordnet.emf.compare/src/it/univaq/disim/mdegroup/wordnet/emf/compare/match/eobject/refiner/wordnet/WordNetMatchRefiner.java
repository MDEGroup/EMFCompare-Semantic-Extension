...
public class WordNetMatchRefiner implements MatchRefiner<SimilarityMatch>{
	...
	//
	private static IndexerWordNetBasic wordnetAdjectiveIndexer; 
	private static IndexerWordNetBasic wordnetAdverbIndexer; 
	//
	...
	static {
		try {
			...
			wordnetAdjectiveIndexer = new IndexerWordNetBasic(uriFactory, wordnetGraph, wordnetDictionaryPath + File.separator + "index.adj");
